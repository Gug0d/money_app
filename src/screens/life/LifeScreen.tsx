  ...
  export default function LifeScreen({ navigation }: Props) {
    ...
    useEffect(() => {
      const unsubscribe = addTutorialTargetFocusListener((targetId) => {
        if (
          targetId !== 'life-main' &&
          targetId !== 'life-profile-button' &&
          targetId !== 'life-advice-button' &&
          targetId !== 'life-bank-button' &&
          targetId !== 'life-missions-button'
        ) {
          return;
        }
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.topBar}>
            <TutorialTarget id="life-profile-button">
              <TouchableOpacity
          ...
          <TutorialTarget id="life-main">
            <View style={styles.worldCard}>
              ...
              <TutorialTarget
                id="life-advice-button"
                style={[styles.mapNode, styles.nodeAdvice]}
              >
                <TouchableOpacity
                  activeOpacity={0.88}
                  onPress={() => {
                    navigation.getParent()?.navigate('Advisor');
                  }}
                >
                  <View style={styles.nodeIconCircle}>
                    <MaterialCommunityIcons
              ...
              >
                ...
                >
                  ...
                  {!bankUnlocked && (
                    <View style={styles.bankUnlockBadge}>
              ...
              <TutorialTarget
                id="life-missions-button"
                style={[styles.mapNode, styles.nodeFinance]}
              >
                <TouchableOpacity
                  activeOpacity={0.88}
                  onPress={() => {
                    navigation.getParent()?.navigate('MissionsTab', {
                      screen: 'MissionsList',
                    });
                  }}
                >
                  ...
                  <Text style={styles.nodeLabelRight}>Миссии</Text>
                </TouchableOpacity>
              </TutorialTarget>
